...
/**
 * A controller class handling interaction with user in test execution session.
 */
public class TestQuestionMiddleController implements Initializable {
	...
	/**
	 * This method will display the user the previous question.
	 * 
	 * @param event - a click on back has occured
	 */
	@FXML
	...
	/**
	 * This method will display the next question.
	 * 
	 * @param event - a click on Next has occured.
	 */
	@FXML
	...
	/**
	 * This method initializes the window with all the data of test that needs to be
	 * displayed.
	 */
	@Override
	...
	/**
	 * This method checks the difference between system's current time and the
	 * test's starting time.
	 * 
	 * @return the difference as a long variable.
	 */
	...
	/**
	 * This function calculates the grade of a executed test and saves its' grade.
	 */
	...
	/**
	 * This method initializes the questions needed to be displayed in the test.
	 */
	...
	/**
	 * This method returns the answer that was marked using the relevant radio
	 * button.
	 * 
	 * @return int represnting the index of the marked answer. (Indexes from 0
	 *         on...)
	 */
	...
	/**
	 * This function retrieves and returns the value of the selected radio button.
	 */
	...
	/**
	 * This method resets the answers.
	 */
	...
	/**
	 * This method initializes the final answers summary table which summarize the
	 * user all of his selected answers - giving him a chance to regret and change
	 * his answers.
	 */
	@FXML
	...
	/**
	 * This method will route the user to the final page, in a case where from some
	 * reason, The test has been locked (de-activated) during execution.
	 */
	...
	/**
	 * This class implements a test clock that measures times for different purposes
	 * of maintaining test schedule - checking if test was intentionally locked by a
	 * teacher, a test extension request for this test was authorized, or whether
	 * the time is up.
	 *
	 */
	class App extends TimerTask {
		...
		/**
		 * an implementation of Thread's run method. This method will initialize the
		 * relevant time counting variables, and check the different conditions for test 
		 * de-activation or lock.
		 */
		public void run() {
			s = totalSeconds % 60;
			h = totalSeconds / 60;
			...
			Platform.runLater(
					new Runnable() {
						...
						public void run() {
							...
							ClientUI.chat
									.accept(new Message(Operation.CheckIfTestIsLocked, execTest.getExecutionCodePK()));
						}
					});
			countUp++;
				...
				Platform.runLater(new Runnable() {
					...
					public void run() {
						ClientUI.chat.accept(
								new Message(Operation.GetTimeForTestInExecution, execTest.getExecutionCodePK()));
					}
				});
