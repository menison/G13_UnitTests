...
/**
 * This class is responsible for the process of bringing the relevant data for report calculation
 * from the DB and manipulating it to our use - displaying the user a visual report.
 *
 */
public class PrincipalGetReport {
	/**
	 * This method returns the relevant report generated by data saved within the DB.
	 * @param msg
	 * @return
	 */
